...
def load_preprocessing(cat_file_path, num_file_path, enc_file_path, stand_file_path):
    cat_file_path = os.path.join(os.path.dirname(__file__), 'Preprocess_and_models', 'apartment', cat_file_path)
    num_file_path = os.path.join(os.path.dirname(__file__), 'Preprocess_and_models', 'apartment', num_file_path)
    enc_file_path = os.path.join(os.path.dirname(__file__), 'Preprocess_and_models', 'apartment', enc_file_path)
    stand_file_path = os.path.join(os.path.dirname(__file__), 'Preprocess_and_models', 'apartment', stand_file_path)
